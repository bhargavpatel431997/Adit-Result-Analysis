...
namespace ARAFFinal.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SubjectId,SubjectName,DepartmentId,SemesterId")] Subject subject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SubjectId,SubjectName,DepartmentId,SemesterId")] Subject subject)
        {
            if (ModelState.IsValid)
            {
